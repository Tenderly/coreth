...
import (
	...
	"github.com/tenderly/coreth/core/extstate/extstatetest"
	"github.com/tenderly/coreth/precompile/contract"
	"github.com/tenderly/coreth/precompile/precompiletest"
...
func TestGetBlockchainID(t *testing.T) {
	...
	precompiletest.RunPrecompileTests(t, Module, extstatetest.NewTestStateDB, tests)
}
