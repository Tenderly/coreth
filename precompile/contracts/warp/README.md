...
Therefore, we use the [Predicate Utils](https://github.com/tenderly/coreth/blob/master/predicate/Predicate.md) package to encode the actual byte slice of size N into the access list.
