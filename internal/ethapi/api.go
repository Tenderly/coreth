...
import (
	...
	"github.com/tenderly/coreth/accounts/scwallet"
	...
	"github.com/tenderly/coreth/eth/gasestimator"
	"github.com/tenderly/coreth/eth/tracers/logger"
...
func (s *PersonalAccountAPI) UnlockAccount(ctx context.Context, addr common.Address, password string, duration *uint64) (bool, error) {
	...
	const max = uint64(time.Duration(math2.MaxInt64) / time.Second)
	var d time.Duration
	if duration == nil {
		d = 300 * time.Second
...
func doCall(ctx context.Context, b Backend, args TransactionArgs, state *state.StateDB, header *types.Header, overrides *StateOverride, blockOverrides *BlockOverrides, timeout time.Duration, globalGasCap uint64) (*core.ExecutionResult, error) {
	...
	// Execute the message.
	gp := new(core.GasPool).AddGas(math2.MaxUint64)
