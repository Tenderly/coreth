...
replace (
	github.com/ava-labs/avalanchego => github.com/tenderly/avalanchego v0.0.0-20241125123149-0845cc03426b
	github.com/gballet/go-verkle => github.com/ethereum/go-verkle v0.2.2
)
